...
COBJS=./src/start.o ./src/pci-class.o ./src/main.o ./src/drivers/ide.o ./src/drivers/pci.o ./src/drivers/serial.o ./src/kstdio.o ./src/arch/x86/idt.o ./src/arch/x86/isr.o ./src/lib/memory.o ./src/arch/x86/interrupts.o
KERNEL=kernel.elf
