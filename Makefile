...
COBJS=./src/start.o ./src/pci-class.o ./src/main.o ./src/drivers/ide.o ./src/drivers/pci.o ./src/drivers/serial.o ./src/kstdio.o ./src/arch/x86/idt.o ./src/arch/x86/isr.o ./src/lib/memory.o ./src/arch/x86/interrupts.o ./src/lib/string.o ./src/mmu/pmm.o ./src/mmu/vmm.o ./src/drivers/acpi.o ./src/arch/x86/msr.o
KERNEL=kernel.elf
